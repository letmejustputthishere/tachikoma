...
import { idlFactory } from './tachikoma_backend.did.js';
export { idlFactory } from './tachikoma_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TACHIKOMA_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tachikoma_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tachikoma_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tachikoma_backend.did.js")._SERVICE>}
 */
export const tachikoma_backend = createActor(canisterId);
